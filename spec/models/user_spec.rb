  ...
  describe 'ユーザー新規登録' do
    ...
    context '異常系' do
      ...
      it '同じメールアドレスは登録できない' do
        @user.save
        second_user = User.new(nickname: 'sample', email: @user.email, password: 'b12345', password_confirmation: 'b12345',
                               last_name: '矢部', first_name: '次郎', last_name_kana: 'ヤベ', first_name_kana: 'ジロウ', birthday: '2010-01-20')
        second_user.valid?
